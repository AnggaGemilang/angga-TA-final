...
<body>
    <main class="main-content  mt-0">
        <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
            ...
            <span style="background-color: rgba(76, 126, 129, 1);" class="mask opacity-6"></span>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Welcome!</h1>
                        <p class="text-lead text-white">We detected <span class="text-bold">SEMS-Y0139836</span> on our
                            system, register to create the account</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <form role="form">
                                ...
                                <div class="text-center">
                                    <button type="button" style="background: #4C7E81; color: white;"
                                        class="btn w-100 my-4 mb-2">Sign up</button>
                                </div>
                            </form>
                        </div>
                    </div>
